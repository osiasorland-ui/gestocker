      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6">
          <div className="flex flex-wrap gap-2">
            ...
            >
              Succès ({notificationCounts.success})
            </button>
            <button
            ...
            >
              Erreurs ({notificationCounts.error})
            </button>
            <button
            ...
            >
              Alertes ({notificationCounts.warning})
            </button>
            <button
            ...
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-500">
                {filter === "all"
                  ...
                  : `Vous n'avez pas de notifications de type ${filter}.`}
              </p>
            </CardContent>
          </Card>
        ) : (
              ...
              return (
                ...
                >
                  <CardContent className="p-0">
                    <div
                      className={`flex items-start p-4 border-l-4 ${style.bgColor} ${style.borderColor}`}
                    >
